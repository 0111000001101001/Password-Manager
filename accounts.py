import getpass
from utils import get_valid_master_username, get_valid_master_password
from database import add_account_to_db, verify_master_account_credentials
...
def authenticate_log_in():
    ...
    for i in range(5):
        ...
        exist_pass = getpass.getpass("Master password: ")
